...
pub fn get_active_app_name() -> String {
    // TODO: Implement proper app detection on Linux
    "Unknown".to_string()
}

pub fn get_running_applications() -> Vec<String> {
    // TODO: Implement proper running applications detection on Linux
...
where
    F: Fn() + Send + 'static,
{
    // TODO: Implement app change callback on Linux
}

pub fn update_launch_on_login(is_enable: bool) -> Result<(), String> {
    // TODO: Implement launch on login for Linux
    Err("Not implemented on Linux".to_string())
}

pub fn is_launch_on_login() -> bool {
    // TODO: Implement launch on login check for Linux
    false
}
...
impl SystemTray {
    ...
    pub fn set_title(&mut self, _title: &str) {
        // TODO: Implement system tray on Linux
    }
